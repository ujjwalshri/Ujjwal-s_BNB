...
const BookingsPage = () => {
  ...
  return (
    <div className='mt-8'>
       ...
       {userBookings?.length > 0 && userBookings.map(booking => (
            <div className='flex m-20 mt-20 gap-0 '> 
                 <img  className='' src={`http://localhost:2000/uploads/${booking.place.photos[0]}`} alt="" />
                <div className=''>
                
                  <motion.div className='w-full h-full border border-black bg-gray-200 pt-8 p-2'   initial={{ x: '10vw' }}   animate={{ x: 0 }}   transition={{ type: 'spring', stiffness: 50, damping: 20, duration:0.1 }}         >
  ...
  <path fillRule="evenodd" d="m11.54 22.351.07.04.028.016a.76.76 0 0 0 .723 0l.028-.015.071-.041a16.975 16.975 0 0 0 1.144-.742 19.58 19.58 0 0 0 2.683-2.282c1.944-1.99 3.963-4.98 3.963-8.827a8.25 8.25 0 0 0-16.5 0c0 3.846 2.02 6.837 3.963 8.827a19.58 19.58 0 0 0 2.682 2.282 16.975 16.975 0 0 0 1.145.742ZM12 13.5a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z" clipRule="evenodd" />
                  ...
                  <h1 className='flex'><span className='font-bold text-xl'>Time </span>  </h1>
                  <h1 className='text-black bg-gray-400 rounded-md p-1 mb-10'>from  {convertISODate(booking.checkInTime)} &rarr; {convertISODate(booking.checkOutTime)}</h1>
                  <h1 className='text-3xl font-mono font-extrabold mb-10 '>Total Price  </h1>
  ...
  <path fillRule="evenodd" d="M9.528 1.718a.75.75 0 0 1 .162.819A8.97 8.97 0 0 0 9 6a9 9 0 0 0 9 9 8.97 8.97 0 0 0 3.463-.69.75.75 0 0 1 .981.98 10.503 10.503 0 0 1-9.694 6.46c-5.799 0-10.5-4.7-10.5-10.5 0-4.368 2.667-8.112 6.46-9.694a.75.75 0 0 1 .818.162Z" clipRule="evenodd" />
                 ...
                 <div className='bg-gray-400 p-2 flex justify-center items-center font-bold text-3xl'>
                    { countDaysBetween(booking.checkInTime, booking.checkOutTime)}
                     </div>

                     <Link to={'/account/bookings/'+ booking.place._id} className='flex  bg-gray-400  mt-16 h-[60px] justify-center items-center font-bold text-2xl p-2 rounded-md' >Explore Booking</Link>
